...
class AppExtensionRuntime implements RuntimeExtensionInterface
{
    ...
    {
        return
           '<svg class="separator-marker" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><g transform="translate(-59.522 -100)"><path transform="matrix(.31998 0 0 .31998 53.853 98.475)" d="m117.26 165.05c0.52662-15.319 16.741-24.149 30.657-21.986 21.108 3.2813 32.679 25.79 28.393 45.606-5.8162 26.891-34.877 41.293-60.555 34.799-32.681-8.2646-49.948-43.98-41.206-75.503 10.671-38.478 53.092-58.626 90.452-47.612 44.279 13.054 67.318 62.209 54.019 105.4-15.422 50.084-71.329 76.02-120.35 60.425-55.891-17.781-84.728-80.452-66.832-135.3 15.601-47.811 62.216-79.76 112.14-79.527" fill="none" stroke-width="17.65"/><path d="m99.856 114.91h59.666" stroke-width="5.6478"/></g></svg>' .
           '<svg class="separator-line" preserveAspectRatio="none" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><g transform="translate(-59.522 -100)"><path d="m159.52 114.92h-100" stroke-width="7.3116"/></g></svg>' .
