...
class AppExtensionRuntime implements RuntimeExtensionInterface
{
    ...
    public function separator(): string
    {
        return
           ...
           '<svg class="separator-line" version="1.1" viewBox="0 0 100 100" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><path d="m0 14.91h100" fill="none" stroke-width="5.648"/></svg>' .
